#
# Description: Sample script for running svm and xgb and creating ens pred data
#
...
compare.xgb.svm <- data.frame(yhat_lin_svm0.1 = svm.c.01.pred,
                                 ...
                                 yhat_xgb2 = xgb.param2.yhat,
                                 yhat_xgb3 = xgb.param3.yhat,
                                 yhat_xgbGini = xgb.fin.giniMod.pred,
                                 yactual = Ytest)


# See top 100 rows
compare.xgb.svm[1:100, ]
